        ...
        switch_boot_auto.setOnCheckedChangeListener(new
                                                            CompoundButton.OnCheckedChangeListener() {
                                                                ...
                                                                public void onCheckedChanged(CompoundButton buttonView, boolean
                                                                    ...
                                                                    editor.putBoolean("boot_ischecked", switch_boot_auto.isChecked());
                                                                    editor.commit();
                                                                    if (isChecked) {
                                                                        //选中work_boot_auto
                                                                        start_flag = 1;
...
//关于
        ...
        //蓝牙
        blueteeth = (TextView) findViewById(R.id.textView5);
        blueteeth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
